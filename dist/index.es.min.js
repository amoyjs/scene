...
d.PIXEL_RATIOS={get x(){var a=isLandScape()?d.view.width:d.view.height;return a/c.resolution/e},get y(){var a=isLandScape()?d.view.height:d.view.width;return a/c.resolution/f}},Object.defineProperty(d,"PIXEL_RATIO",{get:function(){return e<f?d.PIXEL_RATIOS.x:d.PIXEL_RATIOS.y}}),shared.PIXEL_RATIOS=d.PIXEL_RATIOS})}function createScene(a){a.on("create-scene",function(a){var b=a.game,c=a.configure,d=Object.keys(c.scenes).map(function(a){return a.toLowerCase()}),e=Object.values(c.scenes);e.map(function(a,b){return new a(d[b])}),Route.game=b,Route.to(d[0])})}function eventBUS(a){a.on("created",function(b){var c=b.game;c.on=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];a.on.apply(a,b)},c.emit=function(){for(var b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];a.emit.apply(a,b)},c.eventNames=function(){return a.eventNames()}})}var extensions=[eventBUS,extendGame,createScene];function createGame(a){void 0===a&&(a={scenes:{}});var b=a.view;a=Object.assign(defaultConfigure,a),a.view=b||getView(),event.emit("beforeCreate",{PIXI:PIXI,Resource:Resource,configure:a});var c=new Game(a);return event.emit("created",{PIXI:PIXI,Resource:Resource,configure:a,game:c}),event.emit("create-scene",{PIXI:PIXI,Resource:Resource,configure:a,game:c}),c}use(extensions),window.PIXI=PIXI;export{Component,Resource,ResourceLoader,Route,Scene,SizeComponent,createGame,event,getGame,getStage,getType,shared,use};
