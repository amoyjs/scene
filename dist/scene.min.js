(function(a,b){"object"==typeof exports&&"undefined"!=typeof module?b(exports,require("pixi.js")):"function"==typeof define&&define.amd?define(["exports","pixi.js"],b):(a=a||self,b(a.SceneKit={},a.PIXI))})(this,function(a,b){'use strict';function c(a,c){function b(){this.constructor=a}j(a,c),a.prototype=null===c?Object.create(c):(b.prototype=c.prototype,new b)}function d(a,b){var c=Object.keys(b).map(function(a){return a.toLowerCase()}),d=Object.values(b);i.prototype.game=a,d.map(function(a,b){return new a(c[b])});var e=h.create(a);e.to(c[0]),a.ticker.add(function(){return e.update()})}/* eslint-disable max-len */function e(a,b,c,d,e){var f=0,g=null,h=null,j=e.gl;for(var k in a.uniforms){var i=b[k],l=d[k],o=c[k],p=a.uniforms[k];if(!i){p.group&&e.shader.syncUniformGroup(l);continue}if("float"===i.type&&1===i.size)l!==o.value&&(o.value=l,j.uniform1f(o.location,l));/* eslint-disable max-len */else if(("sampler2D"===i.type||"samplerCube"===i.type||"sampler2DArray"===i.type)&&1===i.size&&!i.isArray)/* eslint-disable max-len */e.texture.bind(l,f),o.value!==f&&(o.value=f,j.uniform1i(o.location,f)),f++;else if("mat3"===i.type&&1===i.size)void 0===p.a?j.uniformMatrix3fv(o.location,!1,l):j.uniformMatrix3fv(o.location,!1,l.toArray(!0));else if("vec2"===i.type&&1===i.size)void 0===p.x?(h=o.value,g=l,(h[0]!==g[0]||h[1]!==g[1])&&(h[0]=g[0],h[1]=g[1],j.uniform2f(o.location,g[0],g[1]))):(h=o.value,g=l,(h[0]!==g.x||h[1]!==g.y)&&(h[0]=g.x,h[1]=g.y,j.uniform2f(o.location,g.x,g.y)));else if("vec4"===i.type&&1===i.size)void 0===p.width?(h=o.value,g=l,(h[0]!==g[0]||h[1]!==g[1]||h[2]!==g[2]||h[3]!==g[3])&&(h[0]=g[0],h[1]=g[1],h[2]=g[2],h[3]=g[3],j.uniform4f(o.location,g[0],g[1],g[2],g[3]))):(h=o.value,g=l,(h[0]!==g.x||h[1]!==g.y||h[2]!==g.width||h[3]!==g.height)&&(h[0]=g.x,h[1]=g.y,h[2]=g.width,h[3]=g.height,j.uniform4f(o.location,g.x,g.y,g.width,g.height)));else{var q=1===i.size?m:n;q[i.type].call(null,j,o.location,o.value,l)}}}function f(a){if(!a||!a.systems||!a.systems.ShaderSystem)throw new Error("Unable to patch ShaderSystem, class not found.");var b=a.systems,c=b.ShaderSystem,d=!1;// Do a quick check to see if the patch is needed
...
// uv = uniformValue
// l = location
/* eslint-disable max-len */(function(){// @ts-ignore
"function"!=typeof eval&&f(PIXI),b.Renderer.create=function(a){return new b.Renderer(a)}})(),window.PIXI=b,a.Component=o,a.Scene=i,a.createGame=function(a){var c=a.view;a=Object.assign(l,a);var e=a.UIWidth,f=a.UIHeight,h=a.width,i=a.height,j=a.scenes;a.view=c||g();var k=new b.Application(a);return k.Loader=b.Loader,k.resources=b.Loader.shared.resources,e&&f?(k.UI_DESIGN_RATIO=h/e,k.PIXEL_RATIO={x:h/e,y:i/f}):console.warn("must specified both \"options.UIWidth\" and \"options.UIHeight\" in createGame(options), or you can not use \"game.PIXEL_RATIO\" correctly."),d(k,j),k},a.use=p,a.useScene=d,Object.defineProperty(a,"__esModule",{value:!0})});
