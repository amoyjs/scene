(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FontLoader = /** @class */ (function () {
        ...
        FontLoader.onLoaded = function (onLoaded) {
        ...
        FontLoader.Load = function (paths) {
            ...
            if (isWeChat) {
                ...
                webfontloader.load({
                    ...
                    active: function () { return _this._onLoaded(); }
                });
                return [''];
            }
        };
        FontLoader._onLoaded = function () { };
        return FontLoader;
    }());
            ...
            get: function () {
                ...
                return {
                    ...
                    Load: function (images) {
                        Object.keys(images).map(function (key) { return pixi_js.Loader.shared.add(key, images[key]); });
                    },
                    ...
                    onLoaded: function (onLoaded) {
                        ...
                        pixi_js.Loader.shared.load(function () { return state.needLoadFont ? done() : onLoaded(); });
                        FontLoader.onLoaded(function () { return done(); });
                    }
                };
            },
            enumerable: true,
