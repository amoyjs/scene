 ...
 */var World=/** @class */function(a){function b(b){var c=a.call(this)||this;return c.init(),c.scene=b,c}return __extends(b,a),b.prototype.init=function(){this.x=0,this.y=0},b.prototype.onSceneChange=function(){this.init()},b.prototype.shutdown=function(){this.removeChildren()},b}(Container),Scene=/** @class */function(){function a(b){this.name=b,this.canUpdate=!1,this.world=new World(this),this.game=a.game,this.route=a.route,this.route.push(this)}return Object.defineProperty(a.prototype,"Loader",{get:function(){return{add:function(){for(var a,b=[],c=0;c<arguments.length;c++)b[c]=arguments[c];Loader.shared.resources[b[0]]||(a=Loader.shared).add.apply(a,b)},onLoaded:function(a){void 0===a&&(a=function(){}),Loader.shared.load(a)}}},enumerable:!0,configurable:!0}),a.prototype.switchTo=function(a,b){void 0===b&&(b={}),this.route.to(a,b)},a.prototype.getQuery=function(a){return a?this.route.query[a]:this.route.query},a.prototype.create=function(){},a.prototype.update=function(){},a.prototype.shutdown=function(a){void 0===a&&(a=!0),this.canUpdate=!1,a&&this.world.shutdown()},a}(),Route=/** @class */function(){function a(a){this.game=a,this.scenes={},this.query={},this.prevSceneName=null,this.currentSceneName=null,this.pendingSceneName=null,this.currentScene=null,this.instance=null}/**
